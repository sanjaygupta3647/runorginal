...
class ADMIN_DAL {  
	...
	return '<a href="'.$vars.'&id='.$ids.'"><img src="'.SITE_PATH_ADM.'images/edit.png" width="20" height="20"  alt="Edit record" title="Edit record"/></a>&nbsp;&nbsp;<a href="'.SITE_PATH_ADM.(($tags)?$tags:CPAGE).'?id='.$ids.'&action=del&view=true" onclick="return confirm(\'Do you want delete this record?\');"><img src="'.SITE_PATH_ADM.'images/delete_icon.png" width="20" height="20" alt="Delete record" title="Delete record"/></a>';
	}
	public function cataction($vars, $ids, $tags='',$start){
		return '<a href="'.$vars.'?id='.$ids.'&start='.$start.'"><img src="'.SITE_PATH_ADM.'images/icon_edit.png" alt="Edit record" title="Edit record"/></a>
	...
	public function pageAuth($page,$perm){ 
		if(!in_array($page,$perm)){
