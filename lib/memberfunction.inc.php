...
class ADMIN_DAL {  
	...
	public function action($vars, $ids, $tags=''){
		return '<a href="'.$vars.'&id='.$ids.'"><img src="'.SITE_PATH_MEM.'images/edit.png" width="20" height="20" alt="Edit record" title="Edit record"/></a>&nbsp;&nbsp;<a href="'.SITE_PATH_MEM.(($tags)?$tags:CPAGE).'?id='.$ids.'&action=del&view=true" onclick="return confirm(\'Do you want delete this record?\');"><img src="'.SITE_PATH_MEM.'images/delete_icon.png" width="20" height="20" alt="Delete record" title="Delete record"/></a>';
	}
