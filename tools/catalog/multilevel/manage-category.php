      ...
      <div class="tbl-contant">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  class="data-tbl">
          <tr class="t-hdr">
            ...
            <td width="37%" align="center"><?=$adm->orders('Category',true)?></td>
            <td width="20%" align="center"><?=$adm->orders('Sub Category',true)?></td>
			<td width="7%" align="center"><?=$adm->orders('Order',true)?></td>
          ...
          <tr <?=$adm->even_odd($nums)?>>
            ...
            <td align="center">
            <? //if($parentId){ echo $cms->getSingleresult("select name from #_category where pid='$parentId'")."=>"; }
			echo $name?>
			<?  // echo $name; 
			/*else {
			...
			$tot =$cms->db_query("select pid from #_category where parentId='$pid'");
			 ...
			 <a href="<?=SITE_PATH_ADM.CPAGE."/manage-category.php?parentId=".$pid?>">View(<?=$cnt?>)</a>  
			 </td>
